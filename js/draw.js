function draw(data) {
    ...
    d3.selectAll(".Artist")
        ...
        .attr("y1", function(d, i) {
            return height - margin.top - margin.bottom - (height - margin.top - margin.bottom - y(i * 15) + 30);
        })
    ...
    Artist.selectAll(".focus .album")
        ...
        .on("mousemove", function() {
            return tooltip.style("top", (d3.event.pageY - 50) + "px").style("left", (d3.event.pageX - 50) + "px");
        })
